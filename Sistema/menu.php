            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="logo3.png" class="user-image" alt="User Image" style="    height: auto;">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <a href="https://www.institutomadero.org.ar/" target="_blank">

                <i class="fa fa-calendar"></i> <span>Ir a la web</span>
