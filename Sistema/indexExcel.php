  ...
  if(in_array($_FILES["file"]["type"],$allowedFileType)){
        ...
        for($i=0;$i<$sheetCount;$i++)
        {
            ...
            foreach ($Reader as $Row)
            {
                ...
                $nombres = "";
                if(isset($Row[0])) {
                    $nombres = mysqli_real_escape_string($mysqli,$Row[0]);
                }
                
                $cargo = "";
                if(isset($Row[1])) {
                    $cargo = mysqli_real_escape_string($mysqli,$Row[1]);
                }
				
                $celular = "";
                if(isset($Row[2])) {
                    $celular = mysqli_real_escape_string($mysqli,$Row[2]);
                }
				
                $descripcion = "";
                if(isset($Row[3])) {
                    $descripcion = mysqli_real_escape_string($mysqli,$Row[3]);
                }
